package c.currency.solutions.solution2;
...
/**
 * A graphical solution for a currency converter program.
 * <p>
 * This class includes the methods for currency conversion between US-Dollars and Indian Rupees.
 *
 * @author CSE - Pranavi Sreenivas
 */
...
class CurrencyConverter {
    ...
    public static void converter() {
        ...
        t2 = new JTextField("0");
        t2.setBounds(330, 40, 150, 30);

        // Creating a button for INR,
        // one button for the dollar
        // and one button to close
        // and setting the bounds
        b1 = new JButton("INR -> Dollar");
        b1.setBounds(80, 80, 150, 30);
        b2 = new JButton("Dollar -> INR");
        b2.setBounds(330, 80, 150, 30);
        ...
        b2.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                double value = Double.parseDouble(str2)/1000;
