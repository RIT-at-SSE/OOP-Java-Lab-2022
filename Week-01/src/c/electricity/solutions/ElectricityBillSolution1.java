package c.electricity.solutions;

import java.util.*;

/**
 * A possible solution for the electricity bill program.
 *
 * There is a class CustomerData with useful methods to perform the necessary operations.
 * First a new instance of the CustomerData class is created, on which the different methods are called.
 *
